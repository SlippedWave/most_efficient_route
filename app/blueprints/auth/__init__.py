...
auth.add_url_rule(
    "/iniciar_sesion/recuperar_usuario", view_func=RecoverUserView.as_view("recover_user")
)
auth.add_url_rule('/iniciar_sesion/cambiar_contrasena/<token>', view_func=ResetPasswordView.as_view('reset_password'))
